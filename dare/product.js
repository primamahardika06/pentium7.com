// PRODUK
const buttonLebih = document.querySelector(".lebih")

buttonLebih.addEventListener("click", function(){
  if(buttonLebih.classList.contains("satu")){
    document.querySelectorAll(".box_lebih")[0].style.display ="flex";
    buttonLebih.classList.replace("satu", "dua");
  }else if(buttonLebih.classList.contains("dua")){
    document.querySelectorAll(".box_lebih")[1].style.display ="flex";
    buttonLebih.style.display = "none";
  }
})
// LIKE
